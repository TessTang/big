...
let likeQuan =  [100, 108, 190, 141, 178, 180, 150, 90, 85, 83, 192, 141, 65, 51, 107, 137, 96, 154, 151, 179, 70, 81, 85, 168, 54, 127, 103, 78, 174, 66, 109]; 
...
spinBtn.onclick = function () {
    ...
    // 獲取對應的span值
    let spanValue = targetNumberDiv.querySelector('span').textContent;
